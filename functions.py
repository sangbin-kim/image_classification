...
def loader(train_dir,valid_dir, test_dir):
    ...
    training_transforms = transforms.Compose([transforms.CustomCrop((1840, 0, 2000, 5120)), # Edited transforms.py
                                              transforms.Resize(224),
                                              transforms.ToTensor(),
                                              transforms.Normalize([0.485, 0.456, 0.406],
                                                                   [0.229, 0.224, 0.225])])

    validation_transforms = transforms.Compose([transforms.CustomCrop((1840, 0, 2000, 5120)),
                                                transforms.Resize(224),
                                                transforms.ToTensor(),
                                                transforms.Normalize([0.485, 0.456, 0.406],
                                                                     [0.229, 0.224, 0.225])])

    testing_transforms = transforms.Compose([transforms.CustomCrop((1840, 0, 2000, 5120)),
                                             transforms.Resize(224),
                                             transforms.ToTensor(),
                                             transforms.Normalize([0.485, 0.456, 0.406],
                                                                  [0.229, 0.224, 0.225])])
    ...
    train_loader = torch.utils.data.DataLoader(training_dataset, batch_size=12, shuffle=True)
...
def process_image(image_path):
    ...
    img_transforms = transforms.Compose([transforms.CustomCrop((1840, 0, 2000, 5120)),
                                         transforms.Resize(224),
                                         transforms.ToTensor(),
                                         transforms.Normalize([0.485, 0.456, 0.406],
                                                              [0.229, 0.224, 0.225])])
